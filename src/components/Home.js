                            ...
                            <div className='flex w-fit flex-rows justify-center min-w-[370px] gap-4 pl-6'>
                                ...
                                <>
                                    <div className='flex w-fit flex-rows justify-center min-w-[370px] gap-4 pl-6'>
                                        ...
                                        <div>
                                            <div class="inline-flex mt-2">
                                                <button class="bg-[#1f1f1f] hover:bg-gray-400 text-cyan-400 py-2 px-2 rounded-l text-sm border-solid border-2 border-white h-10" onClick={this.showUserGames}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
