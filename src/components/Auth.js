        ...
        <div className="w-full max-w-fit break-normal flex-wrap">
                ...
                >
                    <div className="w-1/3 py-2">
                            <button className='w-32 h-16 rounded-full border-solid border-2 border-white text-blue-300 bg-white hover:bg-slate-100' onClick={googleLogin}>
                            <div className="inline-flex">
                                        ...
                                        <span className='text-xl mt-2'>Sign In</span>
                                </div>
                            </button>
                        </div>
                </form>
