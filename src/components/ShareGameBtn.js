...
class ShareGameBtn extends Component {
    ...
    render () {
        return(
            ...
            <div className='absolute flex flex-col gap-1.5 w-40 h-20 overflow-y-scroll items-center rounded-lg border-solid border-2 border-white py-2 animate-slide-in -mt-20 bg-gray-800'>
