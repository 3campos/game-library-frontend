...
class EditGameForm extends Component { 
    ...
    render(){
        return(
            <>
            <form onSubmit={this.handleEditGame} className="font-share-tech-mono flex flex-col w-4/5 p-4 max-w-[400px] bg-black rounded sm: mx-10">
            <input
                id='title'
                type='text'
            ...
            <input
                ...
                className='border rounded p-1.5 my-1 text-white hover:bg-violet-900 text-xl'
            />
            </form>
            </>
        )
